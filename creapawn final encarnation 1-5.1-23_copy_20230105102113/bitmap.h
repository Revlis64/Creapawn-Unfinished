...
const unsigned char PROGMEM boardArrowsBackground[]
{
  24, 28, 30, 31, 31, 0 ,0 ,0 ,0 ,0 ,0 , 31, 31, 30, 28, 24,
  24, 56, 120, 248, 248, 0, 0, 0, 0, 0, 0, 248, 248, 120, 56, 24,
};

const unsigned char PROGMEM boardArrowsForeground[]
{
...
const unsigned char PROGMEM strike[]
{
  63, 127, 71, 119, 0, 85, 85, 0,
};

const unsigned char PROGMEM swap[]
{
  4, 8, 87, 99, 117, 8, 16, 0,
};

const unsigned char PROGMEM shockWave[]
{
  65, 34, 93, 34, 93, 34, 28, 0,
};

const unsigned char PROGMEM blast[]
{
  42, 85, 65, 65, 65, 34, 28, 0,
};

const unsigned char PROGMEM healAll[]
{
  14, 17, 33, 66, 33, 17, 14, 0,
};

const unsigned char PROGMEM endure[]
{
  31, 33, 73, 93, 73, 33, 31, 0,
};

const unsigned char PROGMEM sacrifice[]
{
  60, 54, 127, 111, 127, 54, 60, 0,
};

const unsigned char PROGMEM skip[]
{
